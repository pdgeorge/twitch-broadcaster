...
```json
{
  ...
  "badges": [
    { "set_id": "broadcaster", "id": "1", "image_url": "https://static-cdn.jtvnw.net/.../2x" }
  ],
  "fragments": [
  ...
  "message": "hello Kappa",
  "message_html": "<img class='badge' src='...'> <span class='username'>example_user</span>: hello <img class='emote' src='...'>"
}
```

- `message_html` is pre-rendered with Twitch badges/emotes for compatibility.
